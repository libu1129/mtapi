namespace MtApi5
{
    ...
    public enum ErrorCode
    {
        ...
        ErrpublicError                    = 4001, // Unexpected public error
        ErrWrongpublicParameter           = 4002, // Wrong parameter in the inner call of the client terminal function
        ...
        ErrOpenclpublic                   = 5101, // public error occurred when running OpenCL
